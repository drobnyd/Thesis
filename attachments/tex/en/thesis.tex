...
\def\Dedication{%
	...
	Also, I would like to thank Ing. Oldřich Nouza, Ph.D. and RNDr. Luk\'{a}š Hermann for answering all my questions related to Manta Flow. \\
...
\def\Abstrakt{%
	...
	Naše riešenie využíva a zároveň rozširuje Manta Flow, čo je softérový nástroj na vytváranie dátových tokov. \\
}
