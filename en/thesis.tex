...
\begin{enumerate}
	\item Navigate to the directory containing the dm1-reverse-engineering-tool.
	\item Run the "mvn clean compile assembly:single" command producing the executable \TODO{dm1-reverse-engineering-tool-ja.jar} file.
