...
\subsection{Building a Graph representation}

\TODO{describe what graph will be used etc.}
...
\TODO{-get the described objects with properties \\
-build hierarchy \\
-find pairings of physical objects in manta\\
-draw graph} \\

\TODO{where to put this} In order to achieve this goal we must answer these important questions:
\begin{enumerate}
