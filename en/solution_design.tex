...
We are working on development of an automated solution for creating data flows.
The competitors on the field of business data lineage are divided into multiple categories:

\TODO{-Modeling tools - only by hand and lack bigger picture of the data lineage, no other assets than databases.
-}

While none of the solutions provide the automated functionality we aim to provide by putting together Modeling Tools, Manta Flow and finally Metadata Extractor - create an abstraction over databases summarizing real data flow on business assets.
