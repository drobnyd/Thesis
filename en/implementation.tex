...
As we create the mappings symmetrically, the full information is captured on both levels. This way, we are able to create all the mapping edges by going through all objects from a single level of abstraction, no matter which level though.}
