...
When the main API method of a reader - \methodname{read} is called, the parser and resolver start processing one component. Result of their work is a set of related reconstructed \classname{DataModel}s which is the return value from the method. 
